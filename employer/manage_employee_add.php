...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	$insertGoTo = "manage_employees.php";
  if (isset($_SERVER['QUERY_STRING'])) {
	...
	<div id="calendarForForm"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table border="6" cellspacing="0" cellpadding="5" style="border-style:solid" bordercolor="#999999" class="tbl">
        ...
        <tr valign="baseline">
          ...
          <td valign="top" class="tdc2"><input type="text" name="dob" value="<?php echo $encryption->processDecrypt('dob', $_POST['dob']); ?>" size="32">
        ...
        <tr valign="baseline">
          ...
          <td valign="top" class="tdc2"><input type="text" name="account_number" value="<?php echo $encryption->processDecrypt('account_number', $_POST['account_number']); ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
