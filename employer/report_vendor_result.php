...
<?php if($_GET['VendorSubmit']) { ?>
<table width="100%" border="6" cellspacing="0" cellpadding="3" class="blacktbl">
    <tr valign="bottom" >
        <td colspan="2" class="blackth"><font color="#ffffff" face="Tahoma" size="2">Vendor Report Results</font></td>
    </tr>
    <tr valign="top" >
      <td colspan="2" class="blacktd"><?php	  
		if($_GET['vendor_id']) {
		...
		if($_GET['plan_id']) {
			...
			$plan_id = "%";
				...
				$query = "select sum(ec.sra_pretax) as pretax, sum(ec.sra_roth) as roth, vp.plan_name, ec.vendor_id, ec.employer_id from employee_contribution as ec, vendor_plan as vp Where ec.plan_id like '".$plan_id."' and ec.employer_id like '".$employer_id."' and ec.vendor_id like '".$vendor_id."' and ec.plan_id = vp.plan_id GROUP BY ec.plan_id ORDER BY ec.vendor_id, ec.employer_id, ec.plan_id";
