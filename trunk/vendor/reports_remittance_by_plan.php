...
<title>Vendor :: Remittance By Plan</title>
<!-- InstanceEndEditable -->
<?php include('css.php'); ?>
<?php include('js.php'); ?>
...
<script type="text/javascript">
	...
	*/
	...
	<div id="calendarForForm">
	  <form name="searchForm" method="get" action="report_remittance_by_plan_result.php">
      
	    <table width="100%" border="6" cellspacing="0" cellpadding="3" class="greentbl">
          <tr>
            <td class="greenth"><font color="#ffffff" face="Tahoma" size="2">Remittance By <?php echo DISPLAYPLANNAME;?></font></td>
          </tr>
          <tr>
