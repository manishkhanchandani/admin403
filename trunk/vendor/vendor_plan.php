...
if (isset($_COOKIE['vendor']['vendor_id'])) {
  $colname_rsVendor = (get_magic_quotes_gpc()) ? $_COOKIE['vendor']['vendor_id'] : addslashes($_COOKIE['vendor']['vendor_id']);
}
mysql_select_db($database_dw_conn, $dw_conn);
...
if (isset($_COOKIE['vendor']['vendor_id'])) {
  $colname_rsVendorPlans = (get_magic_quotes_gpc()) ? $_COOKIE['vendor']['vendor_id'] : addslashes($_COOKIE['vendor']['vendor_id']);
}
mysql_select_db($database_dw_conn, $dw_conn);
...
<table width="100%" border="6" cellspacing="0" cellpadding="3" class="blacktbl">
    <tr valign="bottom" >
        <td colspan="2" class="blackth"><font color="#ffffff" face="Tahoma" size="2">Add New <?php echo DISPLAYPLANNAME;?> For Vendor <?php echo $row_rsVendor['name']; ?></font></td>
    </tr>
    <tr valign="top" >
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table border="6" cellspacing="0" cellpadding="5" style="border-style:solid" bordercolor="#999999" class="tbl">
    <tr valign="baseline">
      <td nowrap align="right" class="thc2"><?php echo DISPLAYPLANNAME;?> Name:</td>
      <td class="tdc2"><input type="text" name="plan_name" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right" class="thc2"><?php echo DISPLAYPLANNAME;?> Code:</td>
      <td class="tdc2"><input type="text" name="plan_code" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right" valign="top" class="thc2"><?php echo DISPLAYPLANNAME;?> Desc:</td>
      <td class="tdc2"><textarea name="plan_desc" cols="50" rows="5"></textarea>
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right" class="thc2"><?php echo DISPLAYPLANNAME;?> Link:</td>
  ...
  <input name="vendor_id" type="hidden" id="vendor_id" value="<?php echo $_COOKIE['vendor']['vendor_id']; ?>" />
</form>
      </td>
    </tr>
</table>
...
<form name="form2" id="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table border="6" cellspacing="0" cellpadding="5" style="border-style:solid" bordercolor="#999999" class="tbl">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" class="thc2"><?php echo DISPLAYPLANNAME;?>_name:</td>
      <td class="tdc2"><input type="text" name="<?php echo DISPLAYPLANNAME;?>_name" value="<?php echo $row_rsEditPlan['plan_name']; ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" class="thc2"><?php echo DISPLAYPLANNAME;?>_code:</td>
      <td class="tdc2"><input type="text" name="plan_code" value="<?php echo $row_rsEditPlan['plan_code']; ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" valign="top" class="thc2"><?php echo DISPLAYPLANNAME;?>_desc:</td>
      <td class="tdc2"><textarea name="plan_desc" cols="50" rows="5"><?php echo $row_rsEditPlan['plan_desc']; ?></textarea>
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" class="thc2"><?php echo DISPLAYPLANNAME;?>_link:</td>
    ...
    <tr valign="baseline">
      ...
      <td class="tdc2"><input type="submit" value="Update <?php echo DISPLAYPLANNAME;?>" />
...
<table border="6" cellspacing="0" cellpadding="5" style="border-style:solid" bordercolor="#999999" class="tbl" width="100%">
  <tr>
    <td class="thcview2"><strong><?php echo DISPLAYPLANNAME;?> Name </strong></td>
    <td class="thcview2"><strong><?php echo DISPLAYPLANNAME;?> Code </strong></td>
    <td class="thcview2"><strong><?php echo DISPLAYPLANNAME;?> Description </strong></td>
    <td class="thcview2"><strong><?php echo DISPLAYPLANNAME;?> Link </strong></td>
  ...
  <tr>
    ...
    <td class="tdcview2"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?plan_id=<?php echo $row_rsVendorPlans['plan_id']; ?>&vendor_id=<?php echo $row_rsVendor['vendor_id']; ?>&menuTopItem=4#edit">Edit</a> | <a href="vendor_plan_delete.php?<?php echo $MM_keepNone.(($MM_keepNone!="")?"&":"")."plan_id=".urlencode($row_rsVendorPlans['plan_id']) ?>">Delete</a></td>
    </tr>
