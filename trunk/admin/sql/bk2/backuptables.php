...
if($_POST['tbl']) {
	foreach($_POST['tbl'] as $key => $value) {
		// getting structure
		...
		if($_POST['is']==1) {
			...
			if($_POST['mail']==1) {
				mail_attachment ("mkgxy@mkgalaxy.com" , $_POST['email'], $dir."/".$key."_structure.sql", $dir."/".$key."_structure.sql", $string, $key."_structure.sql");
			}
		} else {
		...
		*/
		...
		if(mysql_num_rows($result)>0) {
			...
			if($_POST['is']==1) {
				...
				if($_POST['mail']==1) {
					mail_attachment ("mkgxy@mkgalaxy.com" , $_POST['email'], $dir."/".$key."_data.sql", $dir."/".$key."_data.sql", $data, $key."_data.sql");
				}
			} else {
...
if($_POST['cs']==1) {
	...
	if($_POST['mail']==1) {
		mail_attachment ("mkgxy@mkgalaxy.com" , $_POST['email'], $dir."/".$_POST['d']."_dbstructure.sql", $dir."/".$_POST['d']."_dbstructure.sql", $tableStructure, $_POST['d']."_dbstructure.sql");
	}
}
if($_POST['cd']==1) {
	...
	if($_POST['mail']==1) {
		mail_attachment ("mkgxy@mkgalaxy.com" , $_POST['email'], $dir."/".$_POST['d']."_dbdata.sql", $dir."/".$_POST['d']."_dbdata.sql", $fulldata, $_POST['d']."_dbdata.sql");
	}
}
?>
<br><br>
