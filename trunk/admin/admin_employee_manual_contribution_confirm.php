...
if($arr['showResultInserted']) {
	echo "Contribution of $ ".$_POST['sra_pretax']." in SRA PreTax and $ ".$_POST['sra_roth']." in SRA Roth has been added.";
}
...
<table width="100%" border="6" cellspacing="0" cellpadding="3" class="blacktbl">
    ...
    <tr valign="top" >
      <td colspan="2" class="blacktd">
<form id="form2" name="form2" method="post" action="admin_employee_manual_contribution_confirm2.php">
