    ...
    <tr valign="top" >
      <td colspan="2" class="blacktd">
        ...
        <table width="100%" border="6" cellspacing="0" cellpadding="5" style="border-style:solid" bordercolor="#999999" class="tbl">
          <tr>
            <td valign="top" class="thcview3"><strong>Date</strong></td>
            <td valign="top" class="thcview3"><strong># of records</strong></td>
            <td colspan="2" valign="top" class="thcview3"><strong>Total Amount</strong></td>
            <td valign="top" class="thcview3"><strong># Successful</strong></td>
            <td valign="top" class="thcview3"><strong>#Failed</strong></td>
            <td valign="top" class="thcview3"><strong>#Duplicate</strong></td>
            <td colspan="2" valign="top" class="thcview3"><strong>Amount</strong></td>
            <td colspan="2" valign="top" class="thcview3"><strong>Refund</strong></td>
          </tr>
          <?php do { ?>
          <tr>
            <td valign="top" class="thcview3">&nbsp;</td>
            <td valign="top" class="thcview3">&nbsp;</td>
            <td valign="top" class="thcview3"><strong>Pre Tax</strong></td>
            <td valign="top" class="thcview3"><strong>Roth</strong></td>
            <td valign="top" class="thcview3">&nbsp;</td>
            <td valign="top" class="thcview3">&nbsp;</td>
            <td valign="top" class="thcview3">&nbsp;</td>
            <td valign="top" class="thcview3"><strong>Pre Tax</strong></td>
          ...
          <tr>
            ...
            <td valign="top" class="tdcview2"><font color="#0000ff"><?php echo $row_rsContribution['totalrecordsprocessedsuccessfully']; ?></font></td>
            <td valign="top" class="tdcview2"><font color="#ff0000"><?php echo $row_rsContribution['totalrecordsrejected']; ?></font></td>
            <td valign="top" class="tdcview2"><font color="#ff0000"><?php echo $row_rsContribution['recordsalreadyuploaded']; ?></font></td>
            <td valign="top" class="tdcview2"><font color="#0000ff">$<?php echo $row_rsContribution['totalamountprocessed']; ?></font></td>
            <td valign="top" class="tdcview2"><font color="#0000ff">$<?php echo $row_rsContribution['totalrothprocessed']; ?></font></td>
            <td valign="top" class="tdcview2"><font color="#ff0000">$<?php echo $row_rsContribution['totalamountrefunded']; ?></font></td>
            <td valign="top" class="tdcview2"><font color="#ff0000">$<?php echo $row_rsContribution['totalrothrefunded']; ?></font></td>
          </tr>
          <?php } while ($row_rsContribution = mysql_fetch_assoc($rsContribution)); ?>
        </table>        <p> Records <?php echo ($startRow_rsContribution + 1) ?> to <?php echo min($startRow_rsContribution + $maxRows_rsContribution, $totalRows_rsContribution) ?> of <?php echo $totalRows_rsContribution ?>
