...
function checkForm(i) {
	...
	doAjaxLoadingTextReturn_t1('<?php echo HTTPPATH; ?>/main/processEmployee_t1.php','POST','','transaction_id='+document.getElementById("transaction_id").value+'&h='+document.getElementById("hire_date_"+i).value+'&d='+document.getElementById("dob_"+i).value+'&er='+document.getElementById("employer_id_"+i).value+'&pl='+document.getElementById("plan_id_"+i).value+'&sp='+document.getElementById("sra_pretax_"+i).value+'&sr='+document.getElementById("sra_roth_"+i).value+'&cd='+document.getElementById("contribution_date_"+i).value+'&f='+document.getElementById("firstname_"+i).value+'&l='+document.getElementById("lastname_"+i).value+'&m='+document.getElementById("middlename_"+i).value+'&a='+document.getElementById("account_number_"+i).value+'&s='+document.getElementById("ssn_"+i).value,'showdiv_'+i,'yes','divtr_'+i,document.getElementById("transaction_id").value);
...
if($_POST['transaction_id']) {	
	...
	$transactionId = saveTransaction($sess, $_POST);
}
?>
<br>
...
<table width="100%" border="6" cellspacing="0" cellpadding="3" class="blacktbl">
    ...
    <tr valign="top" >
      <td colspan="2" class="blacktd">
		...
		<input type="hidden" name="transaction_id" id="transaction_id" value="<?php echo $transactionId; ?>" /><input type="hidden" name="total" value="<?php echo $i; ?>" />
