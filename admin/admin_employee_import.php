...
if($_POST['MM_Insert']==1) {
	...
	if($_FILES['userfile']['name']) {
		...
		$errorMessage = "$successtotal of $total <b>records were successfully imported</b>";
		$errorMessage .= "<br>";
		if($success) {
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="6" cellspacing="0" cellpadding="5" style="border-style:solid" bordercolor="#999999" class="tbl">
    ...
    <tr>
      <td align="right" class="thc2">Employer</td>
      <td class="tdc2"><select name="employer_id" id="employer_id">
        <?php
do {  
?>
...
?>
    ...
    <tr>
      ...
      <td class="tdc2"><input type="submit" name="Submit" value="Upload" /></td>
    </tr>
    <tr>
      <td align="right" class="thc2">&nbsp;</td>
      <td class="tdc2"><a href="../main/employeelist.xls" target="_blank">Sample XLS File</a> | <a href="../main/employeelist.csv">Sample CSV File (Tab Seperated) </a></td>
    </tr>
  </table>
</form>
      </td>
