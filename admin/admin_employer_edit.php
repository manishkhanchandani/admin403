...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "frmEmployer")) {
  ...
  $updateGoTo = "admin_employer_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['employer_id'])) {
  $colname_rsEditEmployer = (get_magic_quotes_gpc()) ? $_GET['employer_id'] : addslashes($_GET['employer_id']);
}
mysql_select_db($database_dw_conn, $dw_conn);
...
if (isset($_GET['employer_id'])) {
  $colname_rsDocuments = (get_magic_quotes_gpc()) ? $_GET['employer_id'] : addslashes($_GET['employer_id']);
}
mysql_select_db($database_dw_conn, $dw_conn);
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="frmEmployer">
  <table border="6" cellspacing="0" cellpadding="5" style="border-style:solid" bordercolor="#999999" class="tbl">
    ...
    <tr valign="baseline">
      <td align="right" nowrap class="thc2">Hardship_provision:</td>
    ...
    <tr valign="baseline">
      <td align="right" nowrap class="thc2">Transfers_in:</td>
    ...
    <tr valign="baseline">
      <td align="right" nowrap class="thc2">Transfers_out:</td>
    ...
    <tr valign="baseline">
      <td align="right" nowrap class="thc2">Roth_provision:</td>
  ...
  <input type="hidden" name="MM_update" value="frmEmployer" />
	...
	<!-- Add upload documents here -->	<table width="100%"  border="0" cellspacing="0" cellpadding="5">
      <tr>
