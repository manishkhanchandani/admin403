...
<title>Edit Contribution: Step 1 Choose Date Range</title>
<!-- InstanceEndEditable -->
<?php include('css.php'); ?>
<?php include('js.php'); ?>
...
<table width="100%" border="6" cellspacing="0" cellpadding="3" class="blacktbl">
    <tr valign="bottom" >
        <td colspan="2" class="blackth"><font color="#ffffff" face="Tahoma" size="2">Edit Employee Contribution</font></td>
    </tr>
    <tr valign="top" >
...
<script type="text/javascript">
	...
	*/
	...
	<div id="calendarForForm">
	  <form name="searchForm" method="get" action="admin_employee_editcontribution2.php">
      
	    <table width="100%" border="6" cellspacing="0" cellpadding="3" class="greentbl">
          <tr>
            <td class="greenth"><font color="#ffffff" face="Tahoma" size="2">Choose Period</font></td>
          </tr>
          <tr>
            ...
            <table>
              ...
              <tr>
                <td>From Date:</td>
                <td><input type="text" name="f" value="" onclick="" /></td>
                <td><input type="button" value="Pick date" onclick="pickDate(this,document.searchForm.f);" /></td>
              </tr>
              <tr>
                <td>To Date:</td>
                <td><input type="text" name="t" value="" onclick="" /></td>
                <td><input type="button" value="Pick date" onclick="pickDate(this,document.searchForm.t);" /></td>
              </tr>
                </table>              </td>
          </tr>
          <tr>
            <td align="center" valign="top" class="greentd"><input type="submit" name="EmployerSubmit" id="EmployerSubmit" value="Get Period Report" />
            <input name="menuTopItem" type="hidden" id="menuTopItem" value="2" />
            <input name="employee_id" type="hidden" id="employee_id" value="<?php echo $_GET['employee_id']; ?>" /></td>
          </tr>
        </table>
	  </form>
</div>
