...
<form name="form1" method="get" action="">
  <p>Hostname: 
    <input name="h" type="text" id="h" value="<?php echo $_GET['h']; ?>" size="35">
</p>
  <p>Username: 
    <input name="u" type="text" id="u" value="<?php echo $_GET['u']; ?>" size="32"> 
    Password: 
    <input name="p" type="password" id="p" value="<?php echo $_GET['p']; ?>" size="32">
</p>
  <p>
    <input type="submit" name="Submit" value="Show Database">
  </p>
</form>
<hr>
<table cellpadding="5">
