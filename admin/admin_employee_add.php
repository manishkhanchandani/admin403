...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	if($_POST['ssn'] && $_POST['email'] && $_POST['password'] && ($_POST['password']==$_POST['password'])) {
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	$insertGoTo = "admin_employee_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
	...
	<div id="calendarForForm"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table border="6" cellspacing="0" cellpadding="5" style="border-style:solid" bordercolor="#999999" class="tbl">
        ...
        <tr valign="baseline">
          ...
          <td valign="top" class="tdc2"><input type="text" name="ssn" value="<?php echo $_REQUEST['ssn']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
...
?>
        ...
        <tr valign="baseline">
          ...
          <td valign="top" class="tdc2"><input type="text" name="dob" value="<?php echo $_POST['dob']; ?>" size="32">
        ...
        <tr valign="baseline">
          ...
          <td valign="top" class="tdc2"><input type="text" name="account_number" value="<?php echo $_POST['account_number']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
